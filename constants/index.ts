...
export enum StakeMethod {
  ASSISTED_SOL_DEPOSIT = 'ASSISTED_SOL_DEPOSIT',
  MANUAL_SOL_DEPOSIT = 'MANUAL_SOL_DEPOSIT',
  ASSISTED_STAKE_DEPOSIT = 'ASSISTED_STAKE_DEPOSIT',
  MANUAL_STAKE_DEPOSIT = 'MANUAL_STAKE_DEPOSIT',
  ASSISTED = 'ASSISTED', // For unstake operations
  MANUAL = 'MANUAL', // For unstake operations
}
